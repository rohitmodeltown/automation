...
public class A526API {
	...
	public static void postRequestWithValidData(Hashtable<String, String> data) throws JAXBException
	{
		...
		String NomineeID = xmlPath.getString("Response.NomineeId").toString();
		System.out.println("NomineeId :" +NomineeID);
		
		
		Assert.assertEquals(errorcode, data.get("expectedErrorCode"));
		Assert.assertEquals(NomineeID, data.get("nomineeid"));
